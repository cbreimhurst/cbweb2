 ...
 <section id="competencies">
     ...
     <article>
         <ul class="adjusted">
             ...
             <li><strong>Wireframing and Prototyping:</strong> Proficient in using tools like Sketch, Figma, and Adobe XD to create wireframes and interactive prototypes, enabling iterative design improvements.</li>
